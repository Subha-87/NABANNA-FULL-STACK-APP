...
export const AddEstimateNabanna = () => {
  ...
  return (
    <>
    <Button variant="contained" color="success" onClick={() => setOpen(true)} startIcon={<AddIcon/>}>
         ADD Estimate
    </Button>
...
export const AddChallan = () => {
  ...
  return(
    <>
    <Button variant="contained" color="secondary" onClick={() => setOpen(true)} startIcon={<FileUploadIcon/>}>
         Upload Challan
    </Button>
