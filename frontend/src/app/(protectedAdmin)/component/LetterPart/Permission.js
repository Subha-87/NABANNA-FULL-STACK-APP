...
const Permission = () => {
  ...
  const getToBlock = (name) => {
    ...
    return lines.map((line, i) => (
      <span key={i}>
        {i === 0 ? "To," : ""}
        <br />
        <strong>THE {line.trim().toUpperCase()}</strong>
        {i < lines.length - 1 ? "," : ""}
      </span>
    ));
  };
  ...
  const getCopyBlock = (name) => {
    ...
    return lines.map((line, i) => (
      <span key={i}>
        {i === 0 ? "" : ""}
        <strong>{line.trim().toUpperCase()}</strong>
        {i < lines.length - 1 ? "," : ""}
      </span>
    ));
  };
  ...
  const renderLetter = () => (
    ...
    >
      ...
      {/* Worker Names */}
      <div style={{ fontSize: "12px", marginBottom: "5px", fontWeight: 700 }}>
        Name of the Persons:
      </div>
      <table
        style={{
      ...
      >
        ...
        <tbody>
          {workers.filter((w) => w.trim() !== "").length === 0 ? (
            <tr>
              <td
                style={{
                  border: "1.5px solid #000",
              ...
              <td style={{ border: "1.5px solid #000", padding: "4px 10px" }}>
                ________
              </td>
            </tr>
          ) : (
        ...
        >
          ...
          >
            ...
            <div style={{ ...sectionTitle }}>
              ...
              >
                {workers.filter((w) => w.trim()).length}/15
              </span>
            </div>
            <div style={{ marginBottom: "16px" }}>
